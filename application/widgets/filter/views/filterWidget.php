    ...
    <?php endif; ?>
        ...
        <?php 
            foreach ($item['static_selections'] as $property_id => $select){
                ...
                if ($category_group_id > 0 && $property->depends_on_category_group_id != $category_group_id) {
                    continue;
                }
        ...
        <?php   
                ...
                foreach ($select as $value) {
                    ...
                    // от этого свойства омжет кто-то зависеть
                    // значит этого кого-то надо убрать из селекта
