        ...
        <div class="order-view">
                    ...
                    <td>
                        ...
                        Editable::widget(
                            [
                                ...
                                'displayValue' => $model->status !== null ? Html::tag(
                                    'span',
            ...
            <table class="table table-striped table-bordered">
                ...
                <?php foreach ($model->items as $item): ?>
                    ...
                    <tr>
                        ...
                        <td><?=Yii::$app->formatter->asDecimal(
                                $item->quantity * ($item->product->convertedPrice() + $options['additionalPrice']),
                                2
                            )?></td>
                        <td><?=Html::a(
                ...
                <?php if (isset($model->shippingOption)): ?>
                    <tr>
                        <td colspan="4"><?=Html::encode($model->shippingOption->name)?></td>
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'filter' => \app\components\Helper::getModelMap(
                                \app\models\PaymentType::className(),
                                'id',
                                'name'
                            ),
