...
<div class="tab-content">
        ...
        <div class="row">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <?php BackendWidget::begin([
                        'title'=> Yii::t('app', 'Logic settings'),
                        'icon'=>'cogs',
                        'footer'=>$this->blocks['submit']
                ]); ?>
    ...
    <div class="tab-pane" id="tab-static-values">
...
$js = <<<JS
    ...
    jQuery(".property-tabs a[data-toggle='tab']").on("shown.bs.tab", function(event) {
        localStorage.setItem("propertyActiveTab", "#" + event.target.id);
    });

    jQuery(localStorage.getItem("propertyActiveTab")).click();
JS;
$this->registerJs($js);
?>