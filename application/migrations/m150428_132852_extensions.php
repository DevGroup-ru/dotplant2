...
class m150428_132852_extensions extends Migration
{
    public function up()
    {
        die("Dont apply this migration for now please! It's unfinished");
        $tableOptions = null;
        ...
        $this->createTable('{{%extensions}}', [
            ...
            'force_version' => Schema::TYPE_STRING . ' NOT NULL DEFAULT \'\'',
            'type' => Schema::TYPE_INTEGER . ' NOT NULL DEFAULT 0',
            'latest_version' => Schema::TYPE_STRING . ' NOT NULL DEFAULT \'\'',
            'site_link' => Schema::TYPE_STRING . ' NOT NULL DEFAULT \'\'',
