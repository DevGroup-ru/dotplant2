...
//        }
        ...
        $this->createTable(
            ...
            [
                ...
                'contragent_id' => 'INT UNSIGNED NOT NULL',
        ...
        $this->batchInsert(
            ...
            [
                ...
                [$lastId, 'Stages', 'shop/backend-stage/index', 'usd', 'core', 'order status manage'],
                [$lastId, 'Payment types', 'shop/backend-payment-type/index', 'info-circle', 'core', 'payment manage'],
                [$lastId, 'Shipping options', 'shop/backend-shipping-option/index', 'usd', 'core', 'shipping manage'],
                [$lastId, 'Categories groups', 'shop/backend-category-group/index', 'car', 'core', 'category manage'],
                [$lastId, 'Prefiltered pages', 'shop/backend-prefiltered-pages/index', 'tag', 'core', 'shop manage'],
                [$lastId, 'Currencies', 'shop/backend-currencies/index', 'filter', 'core', 'shop manage'],
