...
class m141117_102416_backend_menu extends Migration
{
    public function up()
    {
        ...
        $backend_menu = array(
          ...
          array('id' => '5','parent_id' => '1','name' => 'Properties','route' => '','icon' => 'cogs','sort_order' => '6','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          ...
          array('id' => '16','parent_id' => '1','name' => 'Data','route' => '','icon' => 'database','sort_order' => '12','added_by_ext' => 'core','rbac_check' => 'data manage','css_class' => '','translation_category' => 'app'),
          ...
          array('id' => '19','parent_id' => '4','name' => 'Categories','route' => 'backend/category/index','icon' => 'tree','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '20','parent_id' => '4','name' => 'Products','route' => 'backend/product/index','icon' => 'list','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'shop'),
          array('id' => '21','parent_id' => '4','name' => 'Orders','route' => 'backend/order/index','icon' => 'list-alt','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'shop'),
          ...
          array('id' => '27','parent_id' => '15','name' => 'Monitor','route' => 'backend/error-monitor/index','icon' => 'flash','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '28','parent_id' => '15','name' => 'Config','route' => 'backend/error-monitor/config','icon' => 'gear','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '29','parent_id' => '16','name' => 'Import','route' => 'backend/data/import','icon' => 'sign-in','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '30','parent_id' => '16','name' => 'Export','route' => 'backend/data/export','icon' => 'sign-out','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '31','parent_id' => '17','name' => 'Settings','route' => 'backend/newsletter/config','icon' => 'gears','sort_order' => '3','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '32','parent_id' => '17','name' => 'Email list','route' => 'backend/newsletter/email-list','icon' => 'list-alt','sort_order' => '2','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '33','parent_id' => '17','name' => 'Send now','route' => 'backend/newsletter/newslist','icon' => 'at','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '34','parent_id' => '18','name' => 'Config','route' => 'backend/config/index','icon' => 'gear','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '35','parent_id' => '18','name' => 'I18n','route' => 'backend/i18n/index','icon' => 'language','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '36','parent_id' => '18','name' => 'Spam Form Checker','route' => 'backend/spam-checker/index','icon' => 'send-o','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app'),
          array('id' => '37','parent_id' => '18','name' => 'Backend menu','route' => 'backend/backend-menu/index','icon' => 'list-alt','sort_order' => '0','added_by_ext' => 'core','rbac_check' => '','css_class' => '','translation_category' => 'app')
        );
        $this->batchInsert(
            BackendMenu::tableName(),
