...
<div class="wishlist-create-block" style="display: none">
    <div class="wishlist-create-block-wrap"  style="background: #ddd; padding: 5px; border-radius: 5px; margin: 5px;">
        ...
        echo Html::submitButton('<i class="fa fa-check"></i>' . Yii::t('app', 'Create'), ['class' => 'btn-create-wishlist btn btn-success']);
        ?>
...
$js = <<<JS
    ...
    $('.create-wishlist-close').on('click', function(e){
        e.preventDefault();
