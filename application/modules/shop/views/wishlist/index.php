            ...
            <?php foreach ($wishlists as $wishlist) : ?>
                ...
                <div class="wishlist-item" data-id="<?= $wishlist->id ?>">
                    ...
                    <?php Modal::begin([
                        ...
                        echo Html::submitButton('<i class="fa fa-check"></i>' . Yii::t('app', 'Save'), ['class' => 'btn-move-wishlist btn btn-success']) ?>
                        <?php ActiveForm::end() ?>
                    <?php Modal::end();?>
                    <div class="wishlist-rename-block" style="display: none">
                        <div class="wishlist-rename-block-wrap" style="background: #ddd; padding: 5px; border-radius: 5px; margin: 5px;">
                            ...
                            echo Html::submitButton('<i class="fa fa-check"></i>' . Yii::t('app', 'Save'), ['class' => 'btn-rename-wishlist btn btn-success']);
                            ?>
