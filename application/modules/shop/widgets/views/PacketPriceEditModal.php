...
<?= Html::input('hidden', 'context', $contextId,
	[
		'id' => 'el_context',
...
<div class="row" id="charge_kind">
	<?= Html::label(Yii::t('app', 'Charge kinds'), 'el_charge_kind', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>">
		<?= Html::dropDownList('charge_kind', null,
			[
...
<div class="row" id="type">
	<?= Html::label(Yii::t('app', 'Operation type'), 'el_type', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>">
...
<div class="row" id="operation">
	<?= Html::label(Yii::t('app', 'Operation'), 'el_operation', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>">
		<?= Html::dropDownList('operation', null,
			[
...
<div class="row" id="apply_for">
	<span class="normal">
		<?= Html::label(Yii::t('app', 'Apply to field'), 'el_apply_for', [
			'class' => 'control-label' . $headColumn
		])?>
	</span>
	<span class="relative">
		<?= Html::label(Yii::t('app', 'Basic field is'), 'el_apply_for', [
			'class' => 'control-label' . $headColumn
		])?>
	</span>
	<div class="<?= $bodyColumn ?>">
		<?= Html::dropDownList('apply_for', null,
			[
...
<div class="row" id="value">
	<?= Html::label(Yii::t('app', 'Charge value'), 'el_value', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>" id="vcont">
		<?= Html::input('text', 'value', '0.0',
			[
				'id' => 'el_value',
				'class' => 'form-control inline'
			]
		...
		<?= Html::dropDownList('currency', null, $currencies, [
				'class' => 'form-control inline',
				'id' => 'el_currency'
		])?>
	</div>
...
<div class="row" id="round">
	<?= Html::label(Yii::t('app', 'Rounding'), 'el_round', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>">
		<?= Html::checkbox('round', true, [
			'id' => 'el_round',
			'class' => 'form-control inline'
		])?>
		<span class="round_options inline">
			<?= Html::input('text', 'round', '2',
				[
					'id' => 'el_round_val',
					'class' => 'form-control inline'
				]
...
<div class="row" id="child">
	<?= Html::label(Yii::t('app', 'Apply to child categories'), 'el_child', [
		'class' => 'control-label' . $headColumn
	])?>
	<div class="<?= $bodyColumn ?>">
		<?= Html::checkbox('child', false, [
			'id' => 'el_child',
			'class' => 'form-control inline'
		])?>
	</div>
